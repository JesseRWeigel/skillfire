...
Measure which installed Claude Code skills actually fire, which never do, and what each costs in always-loaded context

Catalog task: `AGENT-008`. One of a public catalog of build ideas: https://github.com/JesseRWeigel/722-things-to-build
